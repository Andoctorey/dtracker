package com.dtracker.core.store.base;
...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    public static final char[] KEY = {'5', 'd', '6', '=', 'd', 'y', '3', '5', '|', 'r', '2', 'k',
            '7', '7', '!', '@', '3', 'M', 'a', 'g', 'K', '#', '0'};
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putStringSet(String key, Set<String> set) {
            ...
            return delegate.putStringSet(key, encryptedSet);
        }
    ...
    public Set<String> getStringSet(String key, Set<String> defaultSet) {
        Set<String> encryptedSet = delegate.getStringSet(key, defaultSet);
        Set<String> set = new HashSet<>();
        for (String s : encryptedSet) {
            set.add(decrypt(s));
        }
        return set;
    }
